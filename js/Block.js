...
Block.prototype.end = function(){
    var _t = this;
	alert("you have got:"+_t.sum+"score")
	/*
	...
	if( !document.getElementById("againMask") ){
	 ...
	 // againMask.innerHTML =
		'<div id="gove" ><h2 id="againSum">哇塞!你只抢到了'+_t.sum+'红包</h2><h1>难道是大神没附体!</h1><span id="againStart">再来一次？</span><div>';
...
if(_t.sum>=5){
		againMask.innerHTML =
		'<div id="gove" ><h2 id="againSum">哇抢到了'+_t.sum+'红包</h2><h1>好哈哈好啊难附体!</h1><span id="againStart">再来一次？</span><div>';
