/**
 * Created by 韦玉梅 on 2017/4/15.
 */
function aa() {

    var c = document.getElementById('c'),
        $ = c.getContext('2d'),
        w = c.width =document.getElementById("container").offsetWidth,
        h = c.height = document.getElementById("container").offsetHeight;

    var i, bubblesNumber = w * h > 750000 ? 80 : 30,
        objects = [],
        maxRadius = w * h > 500000 ? 25 : 15,
        maxYVelocity = -5;
    ...
    Fragment.prototype.update = function(world) {
        ...
        // console.log( this.velocity.multiply(world.physicalProperties.friction))
    }
    ...
    $.globalCompositeOperation = 'lighter';//属性说明了绘制到画布上的颜色是如何与画布上已有的颜色组合（或“合成”）的。

    world.animate();

    window.addEventListener('resize', function() {
        w = world.physicalProperties.width = c.width = document.getElementById("container").offsetWidth;
        h = world.physicalProperties.height = c.height = document.getElementById("container").offsetHeight;
